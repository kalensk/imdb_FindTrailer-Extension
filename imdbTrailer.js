...
var movieTitle = $('h1').text().slice(0,-18);
var movieTitleLink = encodeURI('"' + movieTitle.slice(1) + '"');
...
if(($(".title-trailer").length)===0){
	var TrailerLink = "http://www.google.com/search?q=" + movieTitleLink + " " + movieYear + "%20trailer&tbm=vid&tbs=dur:s&btnI";
